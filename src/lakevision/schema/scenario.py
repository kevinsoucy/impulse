...
# LakeVision side-car for per-object windowed perception events.
# Populated only when a PerceptionEvent's predicate has track_scope=True selectors.
# Core's event_instance_fact is unchanged; LakeVision-aware reads LEFT JOIN this side-car
# via PerceptionMeasurementDB.event_instance_fact(spark) to recover object_id.
