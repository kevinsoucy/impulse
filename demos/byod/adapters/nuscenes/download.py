...
# NuScenes ships these subdirectories under dataroot. Used to validate
# that an existing dataroot is a complete extraction (not a partial download).
EXPECTED_SUBDIRS = ("maps", "samples", "sweeps")
