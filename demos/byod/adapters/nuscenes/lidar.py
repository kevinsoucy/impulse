...
1. Transform translation into ego frame (x=forward, y=left, z=up — vehicle frame per ADR-9 schema)
...
the OpenLABEL export (notebook 07) is the scoped downstream consumer.
"""
