...
class BYODConfig:
    ...
    @property
    def t_channel_value_labels(self) -> str:
        return f"{self.catalog}.{self.schema_silver}.channel_value_labels"
    ...
    @property
    def t_playlist_items(self) -> str:
        return f"{self.catalog}.{self.schema_perception}.playlist_items"

    @property
    def t_event_instance_fact(self) -> str:
        return f"{self.catalog}.{self.schema_gold}.event_instance_fact"
