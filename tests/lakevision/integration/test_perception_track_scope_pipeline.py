...
the unit-tier coverage in ``tests/lakevision/unit/test_perception_solver_track_scope.py``
...
from lakevision.events.perception_event import PerceptionEvent
from lakevision.query.perception_solver import PerceptionSolver
