"""PerceptionMeasurementDB.event_instance_fact LEFT JOIN'd to the side-car
populates object_id for track-scoped perception rows and leaves it NULL
otherwise.
...
import lakevision.schema as S
from mda_query_engine.measurement_db import MeasurementDBConfig
from mda_reporting.persist.fact_schema import EVENT_INSTANCE_FACT_SCHEMA
from lakevision.perception_db import PerceptionDBConfig, PerceptionMeasurementDB
...
def perception_db(spark):
    ...
    return PerceptionMeasurementDB(
