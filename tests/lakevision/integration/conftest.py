...
def synthetic_nuscenes_bronze(spark):
    ...
    from lakevision.schema.scenario import OBJECT_TRACKS
    from lakevision.schema.silver import PERCEPTION_CHANNELS
...
def synthetic_a2d2_bronze(spark, tmp_path):
    ...
    Fill in when authoring tests/lakevision/integration/test_a2d2_pipeline.py.
    """
    pytest.skip(
