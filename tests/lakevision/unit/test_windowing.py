"""Unit tests for lakevision.windowing.in_any_window — the pure-Python predicate.

The Spark DataFrame helper `filter_dataframe_to_windows` is tested in
tests/lakevision/integration/test_windowing.py where a real SparkSession is
available.
"""

import pytest

from lakevision.windowing import DEFAULT_BUFFER_US, in_any_window
